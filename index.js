  ...
  function CronJob(props) {
    ...
    _defineProperty(
      ...
      function (
        ...
        var operationCronDictCopy = _lodash["default"].cloneDeep(
          _this.state.operationCronDict
        );
    ...
    _defineProperty(
      ...
      function () {
        ...
        _this.state.minuteSeletedList.length &&
          cronExp.set("minute", _this.state.minuteSeletedList);
        _this.state.hourSelectedList.length &&
          cronExp.set("hour", _this.state.hourSelectedList);
        _this.state.daySelectedList.length &&
          cronExp.set("dayOfTheMonth", _this.state.daySelectedList);
        _this.state.weekSelectedList.length &&
          cronExp.set("dayOfTheWeek", _this.state.weekSelectedList);
        _this.state.monthSelectedList.length &&
          cronExp.set("month", _this.state.monthSelectedList);
    ...
    _defineProperty(
      ...
      function (selectedValuesList, unitOfTime) {
        switch (unitOfTime) {
          case "minute":
            _this.setState(
              {
